    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-5 sm:px-8 lg:px-10">
        <SectionHeading
          ...
          subtitle="These are the experiences we hope to offer—from talking drum and Eyo procession to Aso Oke, Yoruba plates, and voices of every generation. The full programme will be confirmed by the committee and announced soon."
        />
        <motion.ul
          variants={list}
          initial="hidden"
